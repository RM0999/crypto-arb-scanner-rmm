...
with st.sidebar:
    ...
    selected_exchanges = st.multiselect("Exchanges", ["Binance", "Kraken", "CoinSpot", "IndependentReserve", "Bitget", "KuCoin", "OKX", "Bybit", "Crypto.com"],
...
api_fetchers = {
    ...
    "Bitget": fetch_placeholder,
    "KuCoin": fetch_placeholder,
    "OKX": fetch_placeholder,
    "Bybit": fetch_placeholder,
    "Crypto.com": fetch_placeholder
}
